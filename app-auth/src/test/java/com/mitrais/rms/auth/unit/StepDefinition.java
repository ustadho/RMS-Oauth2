package com.mitrais.rms.auth.unit;
...
public class StepDefinition {
    ...
    private final InputStream jsonInputStream = this.getClass().getClassLoader().getResourceAsStream("integration.json");
    ...
    public void usersGetInformationOnAProject(String projectName) throws IOException {
        ...
        configureFor("localhost", wireMockServer.port());
        stubFor(get(urlEqualTo("/projects/integration")).withHeader("accept", equalTo(APPLICATION_JSON))
        ...
        assertThat(responseString, containsString("\"testing-framework\": \"integration\""));
        assertThat(responseString, containsString("\"website\": \"integration.io\""));
        verify(getRequestedFor(urlEqualTo("/projects/integration")).withHeader("accept", equalTo(APPLICATION_JSON)));
